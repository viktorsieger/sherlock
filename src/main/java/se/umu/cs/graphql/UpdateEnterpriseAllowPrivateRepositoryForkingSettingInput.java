...
public class UpdateEnterpriseAllowPrivateRepositoryForkingSettingInput {
    ...
    public UpdateEnterpriseAllowPrivateRepositoryForkingSettingInput() {
    }

    public UpdateEnterpriseAllowPrivateRepositoryForkingSettingInput(String clientMutationId, String enterpriseId, EnterpriseEnabledDisabledSettingValue settingValue) {

...
public class RepoConfigEnableCollaboratorsOnlyAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData, RepositoryAuditEntryData{
    ...
    public RepoConfigEnableCollaboratorsOnlyAuditEntry() {
    }

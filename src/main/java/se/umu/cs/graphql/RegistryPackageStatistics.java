...
public class RegistryPackageStatistics {
    ...
    public RegistryPackageStatistics() {
    }

    public RegistryPackageStatistics(Integer downloadsThisMonth, Integer downloadsThisWeek, Integer downloadsThisYear, Integer downloadsToday, Integer downloadsTotalCount) {

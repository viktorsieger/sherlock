...
public class DisconnectedEvent implements IssueTimelineItems, PullRequestTimelineItems, Node{
    ...
    public DisconnectedEvent(Actor actor, String createdAt, String id, Boolean isCrossRepository, ReferencedSubject source, ReferencedSubject subject) {
        this.actor = actor;

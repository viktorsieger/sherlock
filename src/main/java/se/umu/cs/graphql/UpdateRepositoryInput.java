...
public class UpdateRepositoryInput {
    ...
    public UpdateRepositoryInput(String clientMutationId, String description, Boolean hasIssuesEnabled, Boolean hasProjectsEnabled, Boolean hasWikiEnabled, String homepageUrl, String name, String repositoryId, Boolean template) {

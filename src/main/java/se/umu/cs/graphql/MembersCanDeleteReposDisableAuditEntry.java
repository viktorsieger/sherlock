...
public class MembersCanDeleteReposDisableAuditEntry implements OrganizationAuditEntry, AuditEntry, EnterpriseAuditEntryData, Node, OrganizationAuditEntryData{
    ...
    public MembersCanDeleteReposDisableAuditEntry() {
    }

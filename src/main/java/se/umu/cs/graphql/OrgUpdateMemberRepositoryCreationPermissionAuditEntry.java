...
public class OrgUpdateMemberRepositoryCreationPermissionAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData{
    ...
    private OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility visibility;

    public OrgUpdateMemberRepositoryCreationPermissionAuditEntry() {
    }

    public OrgUpdateMemberRepositoryCreationPermissionAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, Boolean canCreateRepositories, String createdAt, String id, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, User user, String userLogin, String userResourcePath, String userUrl, OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility visibility) {
        this.action = action;
        this.actor = actor;
    ...
    public OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility getVisibility() {
        return visibility;
    }
    public void setVisibility(OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility visibility) {
        this.visibility = visibility;
    }

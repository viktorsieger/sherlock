...
public class SmimeSignature implements GitSignature{
    ...
    public SmimeSignature(String email, Boolean isValid, String payload, String signature, User signer, GitSignatureState state, Boolean wasSignedByGitHub) {
        this.email = email;

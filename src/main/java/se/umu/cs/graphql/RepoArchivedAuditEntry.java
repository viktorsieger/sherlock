...
public class RepoArchivedAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData, RepositoryAuditEntryData{
    ...
    private RepoArchivedAuditEntryVisibility visibility;

    public RepoArchivedAuditEntry() {
    }

    public RepoArchivedAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, Repository repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, User user, String userLogin, String userResourcePath, String userUrl, RepoArchivedAuditEntryVisibility visibility) {
        this.action = action;
        this.actor = actor;
    ...
    public RepoArchivedAuditEntryVisibility getVisibility() {
        return visibility;
    }
    public void setVisibility(RepoArchivedAuditEntryVisibility visibility) {
        this.visibility = visibility;
    }

...
public class RepoChangeMergeSettingAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData, RepositoryAuditEntryData{
    ...
    private RepoChangeMergeSettingAuditEntryMergeType mergeType;
    ...
    public RepoChangeMergeSettingAuditEntry() {
    }

    public RepoChangeMergeSettingAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, Boolean isEnabled, RepoChangeMergeSettingAuditEntryMergeType mergeType, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, Repository repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, User user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public RepoChangeMergeSettingAuditEntryMergeType getMergeType() {
        return mergeType;
    }
    public void setMergeType(RepoChangeMergeSettingAuditEntryMergeType mergeType) {
        this.mergeType = mergeType;
    }

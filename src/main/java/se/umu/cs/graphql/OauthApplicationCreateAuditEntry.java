...
public class OauthApplicationCreateAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OauthApplicationAuditEntryData, OrganizationAuditEntryData{
    ...
    private OauthApplicationCreateAuditEntryState state;
    private User user;
    private String userLogin;
    private String userResourcePath;
    private String userUrl;

    public OauthApplicationCreateAuditEntry() {
    }

    public OauthApplicationCreateAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String applicationUrl, String callbackUrl, String createdAt, String id, String oauthApplicationName, String oauthApplicationResourcePath, String oauthApplicationUrl, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, Integer rateLimit, OauthApplicationCreateAuditEntryState state, User user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public OauthApplicationCreateAuditEntryState getState() {
        return state;
    }
    public void setState(OauthApplicationCreateAuditEntryState state) {
        this.state = state;
    }

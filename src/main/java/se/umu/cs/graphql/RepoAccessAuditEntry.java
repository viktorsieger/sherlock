...
public class RepoAccessAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData, RepositoryAuditEntryData{
    ...
    private RepoAccessAuditEntryVisibility visibility;

    public RepoAccessAuditEntry() {
    }

    public RepoAccessAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, Repository repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, User user, String userLogin, String userResourcePath, String userUrl, RepoAccessAuditEntryVisibility visibility) {
        this.action = action;
        this.actor = actor;
    ...
    public RepoAccessAuditEntryVisibility getVisibility() {
        return visibility;
    }
    public void setVisibility(RepoAccessAuditEntryVisibility visibility) {
        this.visibility = visibility;
    }

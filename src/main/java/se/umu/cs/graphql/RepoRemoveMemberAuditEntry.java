...
public class RepoRemoveMemberAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData, RepositoryAuditEntryData{
    ...
    private RepoRemoveMemberAuditEntryVisibility visibility;

    public RepoRemoveMemberAuditEntry() {
    }

    public RepoRemoveMemberAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, Repository repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, User user, String userLogin, String userResourcePath, String userUrl, RepoRemoveMemberAuditEntryVisibility visibility) {
        this.action = action;
        this.actor = actor;
    ...
    public RepoRemoveMemberAuditEntryVisibility getVisibility() {
        return visibility;
    }
    public void setVisibility(RepoRemoveMemberAuditEntryVisibility visibility) {
        this.visibility = visibility;
    }

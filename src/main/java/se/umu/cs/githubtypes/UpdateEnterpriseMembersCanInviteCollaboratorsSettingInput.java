...
public class UpdateEnterpriseMembersCanInviteCollaboratorsSettingInput {
    ...
    public UpdateEnterpriseMembersCanInviteCollaboratorsSettingInput() {
    }

    public UpdateEnterpriseMembersCanInviteCollaboratorsSettingInput(String clientMutationId, String enterpriseId, EnterpriseEnabledDisabledSettingValue settingValue) {

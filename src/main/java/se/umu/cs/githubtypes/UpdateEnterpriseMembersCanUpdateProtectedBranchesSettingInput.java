...
public class UpdateEnterpriseMembersCanUpdateProtectedBranchesSettingInput {
    ...
    public UpdateEnterpriseMembersCanUpdateProtectedBranchesSettingInput() {
    }

    public UpdateEnterpriseMembersCanUpdateProtectedBranchesSettingInput(String clientMutationId, String enterpriseId, EnterpriseEnabledDisabledSettingValue settingValue) {

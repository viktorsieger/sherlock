...
public class OrgAddMemberAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData{
    ...
    private OrgAddMemberAuditEntryPermission permission;
    private User user;
    private String userLogin;
    private String userResourcePath;
    private String userUrl;

    public OrgAddMemberAuditEntry() {
    }

    public OrgAddMemberAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, OrgAddMemberAuditEntryPermission permission, User user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public OrgAddMemberAuditEntryPermission getPermission() {
        return permission;
    }
    public void setPermission(OrgAddMemberAuditEntryPermission permission) {
        this.permission = permission;
    }

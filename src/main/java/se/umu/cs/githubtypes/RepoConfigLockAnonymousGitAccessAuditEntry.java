...
public class RepoConfigLockAnonymousGitAccessAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData, RepositoryAuditEntryData{
    ...
    public RepoConfigLockAnonymousGitAccessAuditEntry() {
    }

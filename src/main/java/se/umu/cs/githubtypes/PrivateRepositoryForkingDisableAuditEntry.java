...
public class PrivateRepositoryForkingDisableAuditEntry implements OrganizationAuditEntry, AuditEntry, EnterpriseAuditEntryData, Node, OrganizationAuditEntryData, RepositoryAuditEntryData{
    ...
    public PrivateRepositoryForkingDisableAuditEntry() {
    }

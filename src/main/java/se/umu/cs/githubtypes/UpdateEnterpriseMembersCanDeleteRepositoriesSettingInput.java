...
public class UpdateEnterpriseMembersCanDeleteRepositoriesSettingInput {
    ...
    public UpdateEnterpriseMembersCanDeleteRepositoriesSettingInput(String clientMutationId, String enterpriseId, EnterpriseEnabledDisabledSettingValue settingValue) {

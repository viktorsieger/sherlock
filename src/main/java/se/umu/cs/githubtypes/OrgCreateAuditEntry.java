...
public class OrgCreateAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData{
    ...
    private OrgCreateAuditEntryBillingPlan billingPlan;
    ...
    public OrgCreateAuditEntry() {
    }

    public OrgCreateAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, OrgCreateAuditEntryBillingPlan billingPlan, String createdAt, String id, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, User user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public OrgCreateAuditEntryBillingPlan getBillingPlan() {
        return billingPlan;
    }
    public void setBillingPlan(OrgCreateAuditEntryBillingPlan billingPlan) {
        this.billingPlan = billingPlan;
    }

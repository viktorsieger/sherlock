...
public class OrgEnableOauthAppRestrictionsAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData{
    ...
    public OrgEnableOauthAppRestrictionsAuditEntry() {
    }

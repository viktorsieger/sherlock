...
public class RepoAddMemberAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData, RepositoryAuditEntryData{
    ...
    private RepoAddMemberAuditEntryVisibility visibility;

    public RepoAddMemberAuditEntry() {
    }

    public RepoAddMemberAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, Repository repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, User user, String userLogin, String userResourcePath, String userUrl, RepoAddMemberAuditEntryVisibility visibility) {
        this.action = action;
        this.actor = actor;
    ...
    public RepoAddMemberAuditEntryVisibility getVisibility() {
        return visibility;
    }
    public void setVisibility(RepoAddMemberAuditEntryVisibility visibility) {
        this.visibility = visibility;
    }

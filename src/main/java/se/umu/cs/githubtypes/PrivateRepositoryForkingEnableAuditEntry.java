...
public class PrivateRepositoryForkingEnableAuditEntry implements OrganizationAuditEntry, AuditEntry, EnterpriseAuditEntryData, Node, OrganizationAuditEntryData, RepositoryAuditEntryData{
    ...
    public PrivateRepositoryForkingEnableAuditEntry() {
    }

    public PrivateRepositoryForkingEnableAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String enterpriseResourcePath, String enterpriseSlug, String enterpriseUrl, String id, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, Repository repository, String repositoryName, String repositoryResourcePath, String repositoryUrl, User user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;

...
public class OrgInviteMemberAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData{
    ...
    public OrgInviteMemberAuditEntry() {
    }

    public OrgInviteMemberAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String email, String id, OperationType operationType, Organization organization, OrganizationInvitation organizationInvitation, String organizationName, String organizationResourcePath, String organizationUrl, User user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;

...
public class UpdateEnterpriseTeamDiscussionsSettingInput {
    ...
    public UpdateEnterpriseTeamDiscussionsSettingInput() {
    }

    public UpdateEnterpriseTeamDiscussionsSettingInput(String clientMutationId, String enterpriseId, EnterpriseEnabledDisabledSettingValue settingValue) {

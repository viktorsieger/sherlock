...
public class TeamChangeParentTeamAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData, TeamAuditEntryData{
    ...
    public TeamChangeParentTeamAuditEntry() {
    }

    public TeamChangeParentTeamAuditEntry(String action, AuditEntryActor actor, String actorIp, ActorLocation actorLocation, String actorLogin, String actorResourcePath, String actorUrl, String createdAt, String id, Boolean isLdapMapped, OperationType operationType, Organization organization, String organizationName, String organizationResourcePath, String organizationUrl, Team parentTeam, String parentTeamName, String parentTeamNameWas, String parentTeamResourcePath, String parentTeamUrl, Team parentTeamWas, String parentTeamWasResourcePath, String parentTeamWasUrl, Team team, String teamName, String teamResourcePath, String teamUrl, User user, String userLogin, String userResourcePath, String userUrl) {
        this.action = action;
        this.actor = actor;
    ...
    public Team getParentTeamWas() {
        return parentTeamWas;
    }
    public void setParentTeamWas(Team parentTeamWas) {
        this.parentTeamWas = parentTeamWas;
    }

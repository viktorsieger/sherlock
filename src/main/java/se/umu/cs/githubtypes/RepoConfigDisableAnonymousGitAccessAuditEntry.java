...
public class RepoConfigDisableAnonymousGitAccessAuditEntry implements OrganizationAuditEntry, AuditEntry, Node, OrganizationAuditEntryData, RepositoryAuditEntryData{
    ...
    public RepoConfigDisableAnonymousGitAccessAuditEntry() {
    }
